...
[Keep a Changelog](https://keepachangelog.com/en/1.1.0/). Releases adhere to
[Semantic Versioning](https://semver.org/spec/v2.0.0.html); pre-releases are spelled in
[PEP 440](https://peps.python.org/pep-0440/) style — `0.0.3.dev1`, not `0.0.3-dev.1` — so that
`pip` excludes them unless `--pre` is passed.
